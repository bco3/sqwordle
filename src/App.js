...
export const App = () => {
  ...
  function pressKey(key) {
    console.log(`pressKey is ${key}`);
    // const activeTiles = getActiveTiles();
    if (position.letterPosition >= wordLength * 2 - 1) return;
    ...
    // let nextTile = tiles[position.row][position.letterPosition];
    setTiles(newTiles);
    let newPosition = { ...position };
    newPosition.letterPosition = position.letterPosition + 2;
    setPosition({ ...newPosition });
  ...
  function submitGuess() {
    ...
    if (position.letterPosition !== wordLength * 2) {
  ...
  function flipTile(tile, index, array, guess) {
    ...
    }, (index * FLIP_ANIMATION_DURATION * 2) / 3);
    ...
    }, (index * FLIP_ANIMATION_DURATION * 2) / 3 + FLIP_ANIMATION_DURATION * 2);
  }
  ...
  function checkWinLose(guess, word) {
    ...
    if (position.row === 5) {
      showAlert(correctWord.toUpperCase(), 5000);
      for (let i = position.row; i >= 0; i--) {
        let newTilesWin = [...tiles];
        newTilesWin[i].forEach((_, index) => {
          if (index % 2 !== 0) {
  ...
  return (
    <div className="container">
      <div className="header">
        <div className="new-word" id="new-game">
          {currentStreak}
        </div>
        <div className="title">
